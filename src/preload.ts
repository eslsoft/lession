...
const api: ElectronAPI = {
  ...
  download: {
    ...
    delete: (id, deleteFiles) => ipcRenderer.invoke(IPC.DOWNLOAD_DELETE, id, deleteFiles),
    clearCompleted: (deleteFiles) => ipcRenderer.invoke(IPC.DOWNLOAD_CLEAR_COMPLETED, deleteFiles),
