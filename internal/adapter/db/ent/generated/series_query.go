...
func (_q *SeriesQuery) QueryEpisodes() *EpisodeQuery {
...
func (_q *SeriesQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *SeriesQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *SeriesQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *SeriesQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *SeriesQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *SeriesQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SeriesQuery) WithEpisodes(opts ...func(*EpisodeQuery)) *SeriesQuery {
	query := (&EpisodeClient{config: _q.config}).Query()
...
func (_q *SeriesQuery) loadEpisodes(ctx context.Context, query *EpisodeQuery, nodes []*Series, init func(*Series), assign func(*Series, *Episode)) error {
...
func (_q *SeriesQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(series.Table, series.Columns, sqlgraph.NewFieldSpec(series.FieldID, field.TypeUUID))
	_spec.From = _q.sql
