...
const (
	...
	// FieldTeacher holds the string denoting the teacher field in the database.
...
// ByTeacher orders the results by the teacher field.
func ByTeacher(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTeacher, opts...).ToFunc()
}
